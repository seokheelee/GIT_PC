 ...
 * Subject : CJ Mall 운영 
 * Name : TC_117
 * Scenario : 비로그인 상태로 마이존 클릭시 로그인 페이지 노출
 * Assertion : "로그인" Text 체크
 *
 */

public class Live_TC117 {
	...
	@Test
	public void TC117() throws Exception {
		try {
			...
			// 로그인 기다림
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='login_area']/form/div/div/div[2]/input")));
			System.out.println("로그인 기다림");
			
			// "로그인" Text 체크
			if ("".equals(driver.findElement(By.xpath(".//*[@id='login_area']/form/div/div/div[2]/input")).getText())) {

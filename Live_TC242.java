 ...
 * Subject : CJ Mall 운영 
 * Name : TC_242
 * Scenario : 회원정보 > Email/SMS 수신설정 > SMS 번호 입력확인
 * Assertion : SMS inputbox 확인
 *
 */

public class Live_TC242 {
	...
	@Test
	public void TC242() throws Exception {
		try {
			...
			// E-mail/SMS 수신설정 뜰 때까지 기다림.
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='midLeft']/div/ul/li[4]/ul/li[2]/a")));
			System.out.println("E-mail/SMS 수신설정 뜰 때까지 기다림");

			// E-mail/SMS 수신설정 클릭
			driver.findElement(By.xpath(".//*[@id='midLeft']/div/ul/li[4]/ul/li[2]/a")).click();
			System.out.println("E-mail/SMS 수신설정 클릭");
			
			// SMS selectbox 뜰 때까지 기다림.
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='sub2_right']/div/div[1]/form/dl[1]/dd/select")));
			System.out.println("SMS selectbox 뜰 때까지 기다림");
						
			String n1 = driver.findElement(By.xpath(".//*[@id='sub2_right']/div/div[1]/form/dl[1]/dd/select")).getAttribute("value"); // SMS 010,011 등 번호
			String n2 = driver.findElement(By.xpath(".//*[@id='sub2_right']/div/div[1]/form/dl[1]/dd/input[1]")).getAttribute("value"); // SMS 중간 번호
			String n3 = driver.findElement(By.xpath(".//*[@id='sub2_right']/div/div[1]/form/dl[1]/dd/input[2]")).getAttribute("value"); // SMS 마지막 번호
			
			// SMS 번호 입력값 null 체크
			if(!"".equals(n1) && !"".equals(n2) && !"".equals(n3)){
				System.out.println("[TC_242] success");
				assertTrue(true);
				return;
			} else {
				System.out.println("[TC_242] failure : SMS 번호 null 존재함");
				assertTrue(false);
			}
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("[TC_242] failure");
			assertTrue(false);
		}
	}

...
public class PC_Live_test {
	...
	public void setUp() throws Exception {
		...
		baseUrl = "http://display.cjmall.com/";
	...
	@Test
	public void pclivetest() throws Exception {
		...
		try {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='header']/div[1]/div[5]/ul/li[1]/a")));
...
/*			// 2-1. 팝업창이 뜰경우 팝업창 다시 보지 않기 선택
			...
			*/
			...
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath(".//*[@id='header']/div[1]/div[5]/ul/li[1]/a/span"), "로그아웃"));

			// 4. TV 쇼핑 버튼 누르기
			driver.findElement(By.xpath(".//*[@id='header']/div[1]/div[4]/div[1]/ul/li[1]/a/span")).click();
			
			// 5. 생방송 LIVE 뜰 때까지 기다림.
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath(".//*[@id='liveArea']/div[1]/h3"), "LIVE"));
			
			// 6. 생방송 화면 누르기
			driver.findElement(By.xpath(".//*[@id='liveVideo']/button")).click();

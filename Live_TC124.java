 ...
 * Subject : CJ Mall 운영 
 * Name : TC_124
 * Scenario : 로그인 > 마이존 > 상품권  노출
 * Assertion : "상품권 ~원" Text 체크
 *
 */

public class Live_TC124 {
	...
	@Test
	public void TC124() throws Exception {
		try {
			...
			System.out.println("상품권 뜰 때까지 기다림");
						
			// "상품권 ~원" Text 체크
			if ("상품권".equals(driver.findElement(By.xpath(".//*[@id='wrap']/div[1]/div[2]/div[2]/div[2]/table/tbody/tr[1]/th[3]/strong/a")).getText())) {
				System.out.println("[TC_124] success");
				assertTrue(true);
				return;
			} else {
				System.out.println("[TC_124] failure : '상품권~원' Text 불일치");
				assertTrue(false);
			}
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("[TC_124] failure");
			assertTrue(false);
		}
	}

 ...
 * Subject : CJ Mall 운영 
 * Name : TC_112
 * Scenario : 로그인 > 장바구니 선택 시 장바구니 페이지로 이동 확인 
 * Assertion : 장바구니 img alt 확인
 *
 */

public class Live_TC112 {
	...
	public void TC112() throws Exception {
		try {
			...
			// 장바구니 img 뜰 때까지 기다림.
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='cjm_container']/div/div[2]/div[1]/h2/img")));
			System.out.println("장바구니 img 뜰 때까지 기다림");
			
			// 장바구니 img alt 확인
			if ("장바구니".equals(driver.findElement(By.xpath(".//*[@id='cjm_container']/div/div[2]/div[1]/h2/img")).getAttribute("alt"))) {
				System.out.println("[TC_112] success");
				assertTrue(true);
				return;
			} else {
				System.out.println("[TC_112] failure : '장바구니' img alt 불일치");
				assertTrue(false);
			}
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("[TC_112] failure");
			assertTrue(false);
		}
	}

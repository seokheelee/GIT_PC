 ...
 * Subject : CJ Mall 운영 
 * Name : TC_129
 * Scenario : 로그인 > 마이존 > 쇼핑지원금 클릭시 해당 탭 이동 확인
 * Assertion : "쇼핑플러스쿠폰은 일반 할인쿠폰과 중복해서  사용하실 수 있는 쿠폰입니다.~" Text 체크
 *
 */

public class Live_TC129 {
	...
	public void TC129() throws Exception {
		try {
			...
			// 쇼핑지원금 클릭
			driver.findElement(By.xpath(".//*[@id='wrap']/div[1]/div[2]/div[2]/div[2]/table/tbody/tr[3]/th[1]/strong/a")).click();
			System.out.println("쇼핑지원금 클릭");
			...
			if (!"".equals(driver.findElement(By.xpath(".//*[@id='sub2_right']/div/div[2]/div/form/ul/li[5]")).getText())) {
				System.out.println("[TC_129] success");
				assertTrue(true);
				return;
			} else {
				System.out.println("[TC_129] failure : '쇼핑플러스쿠폰은 일반 할인쿠폰과 중복해서  사용하실 수 있는 쿠폰입니다.~' Text null...");
				assertTrue(false);
			}
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("[TC_129] failure");
			assertTrue(false);
		}
	}

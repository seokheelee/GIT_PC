 ...
 * Subject : CJ Mall 운영 
 * Name : TC_005
 * Scenario : "기획전" 클릭시 기획전 메인화면 전환 확인
 * Assertion : "베스트 쇼핑기획전" Text 체크
 *
 */

public class Live_TC005 {
	...
	public void TC005() throws Exception {
		try{
			...
			// 기획전 클릭
			driver.findElement(By.xpath(".//*[@id='cjo_wrap']/div[2]/div/div/div[2]/ul/li[5]/a/strong")).click();
			System.out.println("기획전 클릭");
			
			// "베스트 쇼핑기획전" Text 체크
			boolean isExist = existElement(driver, By.xpath(".//*[@id='planshopNavBest']/div[1]/ul/li[1]/a/span"), "기획전");
			if (isExist && driver.findElement(By.xpath(".//*[@id='planshopNavBest']/div[1]/ul/li[1]/a/span")).getText().equals("베스트 쇼핑기획전")) {
				System.out.println("[TC_005] success");
				assertTrue(true);
				return;
			} else {
				System.out.println("[TC_005] failure : 베스트 쇼핑기획전 Text 불일치");
				assertTrue(false);
			}
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("[TC_005] failure");
			assertTrue(false);
		}
	}

 ...
 * Subject : CJ Mall 운영 
 * Name : TC_119
 * Scenario : 로그인 > 마이존 > 할인쿠폰 노출
 * Assertion : "할인쿠폰 ~개" Text 체크
 *
 */

public class Live_TC119 {
	...
	@Test
	public void TC119() throws Exception {
		try {
			...
			// 할인쿠폰 뜰 때까지 기다림.
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='wrap']/div[1]/div[2]/div[2]/div[2]/table/tbody/tr[1]/th[1]/strong/a")));
			System.out.println("할인쿠폰 뜰 때까지 기다림");
			
			// "할인쿠폰 ~개" Text 체크
			if ("할인쿠폰".equals(driver.findElement(By.xpath(".//*[@id='wrap']/div[1]/div[2]/div[2]/div[2]/table/tbody/tr[1]/th[1]/strong/a")).getText())) {
				System.out.println("[TC_119] success");
				assertTrue(true);
				return;
			} else {
				System.out.println("[TC_119] failure : '할인쿠폰' Text 불일치");
				assertTrue(false);
			}
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("[TC_119] failure");
			assertTrue(false);
		}
	}

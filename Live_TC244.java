...
public class Live_TC244 {
	...
	@Test
	public void TC244() throws Exception {
		try {
			...
			// E-mail inputbox 뜰 때까지 기다림.
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='sub2_right']/div/div[1]/form/dl[3]/dd/input")));
			System.out.println("E-mail inputbox 뜰 때까지 기다림");
			
			String n1 = driver.findElement(By.xpath(".//*[@id='sub2_right']/div/div[1]/form/dl[3]/dd/input")).getAttribute("value"); // Email 아이디계정 값
			String n2 = driver.findElement(By.xpath(".//*[@id='sub2_right']/div/div[1]/form/dl[3]/dd/select")).getAttribute("value"); // Email 도메인 값
						
			// Email 입력값 null 체크
			if(!"".equals(n1) && !"".equals(n2)){
				System.out.println("[TC_244] success");
				assertTrue(true);
				return;
			} else {
				System.out.println("[TC_244] failure : Email null 존재함");
				assertTrue(false);
			}
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("[TC_244] failure");
			assertTrue(false);
		}
	}

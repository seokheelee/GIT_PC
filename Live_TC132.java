 ...
 * Subject : CJ Mall 운영 
 * Name : TC_132
 * Scenario : 로그인 > 마이존 > 상품권 클릭시 해당 탭 이동 확인
 * Assertion : "CJ상품권" img alt 확인
 *
 */

public class Live_TC132 {
	...
	public void TC132() throws Exception {
		try {
			...
			// 상품권 클릭
			driver.findElement(By.xpath(".//*[@id='wrap']/div[1]/div[2]/div[2]/div[2]/table/tbody/tr[1]/th[3]/strong/a")).click();
			System.out.println("상품권 클릭");
			
			// CJ상품권 뜰 때까지 기다림.
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='sub2_right']/div/div[2]/h1/ul/li[1]/img")));
			System.out.println("CJ상품권 뜰 때까지 기다림");
			
			// "CJ상품권" img alt 확인
			if ("cj상품권".equals(driver.findElement(By.xpath(".//*[@id='sub2_right']/div/div[2]/h1/ul/li[1]/img")).getAttribute("alt"))) {
				System.out.println("[TC_132] success");
				assertTrue(true);
				return;
			} else {
				System.out.println("[TC_132] failure : 'CJ상품권' img alt 불일치");
				assertTrue(false);
			}
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("[TC_132] failure");
			assertTrue(false);
		}
	}

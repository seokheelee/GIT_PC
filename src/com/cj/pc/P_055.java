 ...
 * Subject : CJ Mall 운영 
 * Name : TC_55
 * Scenario :고객센터 > 개인정보 이용내역 버튼 선택 > ID / PW 입력 > 로그인
 * Assertion : 개인정보 이용내역 Text 체크
 *
 */
...
public class P_055 {
	...
	@Test
	public void p_055() throws Exception {
		driver.get(P_URL);
		...
		if ("개인정보 이용내역".equals(
			...
			System.out.println("TC_53 Pass");
			assertTrue(true);
			return;
		} else {
			System.out.println("TC_53 Fail");
			assertTrue(false);
		}
	}

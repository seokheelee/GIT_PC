...
public class P_041 {
	...
	@Test
	public void p_041() throws Exception {
		driver.get(P_URL);
		// 로그인
		...
		System.out.println("편성표 다음날 클릭 성공");
		Thread.sleep(3000);
		// 상품 진입
		// 스크롤 내리기
		...
		// 방송알림 신청 텍스트 확인
		if ("방송알림신청".equals(driver.findElement(By.xpath("//*[@id='content']/div[2]/div[1]/div[2]/div[1]/div/a/em")).getText())) {
